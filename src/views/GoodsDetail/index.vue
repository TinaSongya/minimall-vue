...
<template>
  <div class="w store-content">
      ...
      <div class="banner">
        <div class="sku-custom-title">
          ...
          <h6>
            ...
            <span class="price">
              <em>¥</em><i>{{ Number(product.salePrice).toFixed(2) }}</i></span>
          </h6>
        </div>
        <div class="num">
    ...
    <!--产品信息-->
  <div class="item-info">
    <m-shelf title="产品信息"></m-shelf>
   <div slot="content">
     <div v-if="product.detail">
       <div v-html="product.detail"></div>
     </div>
     <div class="no-info" v-else>
       <img src="/src/common/static/images/no-data.png" alt="">
       <br>该商品暂无内容数据
     </div>
   </div>
  </div>
...
import MShelf from '/src/components/shelf'
import BuyNum from '/src/components/BuyNum.vue'
