   ...
   <div>
     <header class="w">
       <div class="w-box">
         <div class="nav-logo">
           <h1>
             <router-link to="/" title="商城官网" href="#">MiniMall 商城</router-link>
           </h1>
         </div>
         <div class="right-box">
           <div class="nav-list">
               ...
               <div class="nav-user-wrapper pa active" v-show="showCart">
                 <div class="nav-user-list">
                   <div class="full">
                                 ...
                                 <div class="item-desc">
                                   <div class="cart-cell">
                                     ...
                                     <h6><span class="price-icon">¥</span><span
                                         class="price-num"></span><span
                                         class="item-num">x </span>
                                     </h6></div>
                                 </div>
                               </a>
                     ...
                     <!--总件数-->
                     <div class="nav-cart-total"><p>共 <strong></strong> 件商品</p> <h5>合计：<span
                         class="price-icon">¥</span><span
                         class="price-num"></span></h5>
                       <h6>
                       </h6>
                     </div>
                   </div>
